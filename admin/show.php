...
@page { margin: 0; }
	...
	?> 
		<header>
			...
			<address >
				<p>SUN VIEW RESORT,</p>
				<p>123 Coastal Paradise Road,<br>Tanjung Aru Beach,<br>88100 Kota Kinabalu,<br>Sabah, Malaysia.</p>
				<p>+088-222445</p>
			</address>
			<span><img alt="LOGO RESORT" src="assets/img/sun1.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
			<p align="center">Email : langchingpin23@gmail.com | Web: https://127.0.0.1/hotel/admin/show | Phone : +088-222445 </p>
			</div>
		</aside>
	</body>
</html>
